...
public:
    ...
    bool validPathRecursiveDFS(int n, vector<vector<int>>& edges, int source, int destination);

    // Same as above but using iterative DFS with a stack
    bool validPathIterativeDFS(int n, vector<vector<int>>& edges, int source, int destination);
    ...
    bool validPathUnionFind(int n, vector<vector<int>>& edges, int source, int destination);
